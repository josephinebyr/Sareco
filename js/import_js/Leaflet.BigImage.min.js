...
(function(t){
    t.Control.BigImage=t.Control.extend({
        options:{
            ...
            maxScale:10,
            minScale:1,
            inputTitle:"Choisissez l'échelle (de 1 à 10 : échelle de plus en plus petite):",
            downloadTitle:"Télécharger"
        },
        onAdd:function(t){
            this._map=t;
            const e=this.options.printControlTitle,i=this.options.printControlLabel;
            let n=this.options.printControlClasses;
            return-1!=i.indexOf("&")&&n.push(this.options._unicodeClass),
            this._createControl(i,e,n,this._click,this)},
            _click:function(t){
            ...
            _createDownloadButton:function(){
                ...
                this._downloadBtn.addEventListener("click",()=>{
                    ...
                    !t||t<this.options.minScale||t>this.options.maxScale?this._scaleInput.value=this.options.minScale:(this._containerParams.classList.add("print-disabled"),
                    this._loader.style.display="block",this._print())}),
            ...
            _getLayers:function(e){
                ...
                i._map.eachLayer(function(e){
                    n.push(new Promise(n=>{
                        try{
                            e instanceof t.Marker&&e._icon&&e._icon.src?i._getMarkerLayer(e,n):e instanceof t.TileLayer?i._getTileLayer(e,n):e instanceof t.Circle?(i.circles[e._leaflet_id]||(i.circles[e._leaflet_id]=e),n()):e instanceof t.Path?i._getPathLayer(e,n):n()
                        }catch(t){
                            console.log(t),n()
                        }
                    }))
            ...
            _getTileLayer:function(e,i){
                ...
                n.tiles.forEach(i=>{
                    ...
                    let a=s.scaleBy(new t.Point(n.tileSize,n.tileSize)).subtract(n.bounds.min);i.y<0||o.push(new Promise(t=>{n._loadTile(i,a,e,t)}))
                }),
            ...
            _loadTile:function(t,e,i,n){
                ...
                a.onload=function(){o.tilesImgs[s]||(o.tilesImgs[s]={img:a,x:e.x,y:e.y}),n()},
                a.src=i.getTileUrl(t)
            },
            _getMarkerLayer:function(e,i){
                let n=this;if(n.markers[e._leaflet_id])return void i();
                let o=n._map.project(e._latlng);
                if(o=o.subtract(new t.Point(n.bounds.min.x,n.bounds.min.y)),e.options.icon&&e.options.icon.options&&e.options.icon.options.iconAnchor&&(o.x-=e.options.icon.options.iconAnchor[0],o.y-=e.options.icon.options.iconAnchor[1]),n._pointPositionIsNotCorrect(o))
                    i();
                    else{
                        let t=new Image;
                        t.crossOrigin="Anonymous",
                        t.onload=function(){
                            n.markers[e._leaflet_id]={img:t,x:o.x,y:o.y},
                            i()
                        },
                        t.src=e._icon.src
                    }
                ...
                _getPathLayer:function(e,i){
                    let n=this,o=0,s=[];
                    !e._mRadius&&e._latlngs?((e.options.fill?e._latlngs[0]:e._latlngs).forEach(e=>{let i=n._map.project(e);
                        i=i.subtract(new t.Point(n.bounds.min.x,n.bounds.min.y)),s.push(i),i.x<n.canvas.width&&i.y<n.canvas.height&&(o=1)}),o&&(n.path[e._leaflet_id]={parts:s,closed:e.options.fill,options:e.options}),i()):i()
                },
                ...
                _drawPath:function(t){
                    ...
                    e.ctx.beginPath();
                    let i=0,n=t.options;
                    t.parts.forEach(t=>{e.ctx[i++?"lineTo":"moveTo"](t.x,t.y)}),
                ...
                _feelPath:function(t){
                    ...
                    t.stroke&&0!==t.weight&&(this.ctx.setLineDash&&this.ctx.setLineDash(t&&t._dashArray||[])
                ...
                _print:function(){
                    ...
                    new Promise(function(e,i){t._getLayers(e)})
                    .then(()=>new Promise((e,i)=>{
                        ...
                        for(const[e,i]of Object.entries(t.circles))t._drawCircle(i);e()
                    }))
                    .then(()=>{
                        t.canvas.toBlob(
                            function(t){
                                let e=document.createElement("a");
                                e.download="telechargement_sarecoscope.png",
